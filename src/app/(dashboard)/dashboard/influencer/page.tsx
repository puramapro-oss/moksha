...
import { Sparkles, Link2, Copy, Users, MousePointerClick, TrendingUp } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-white/60">
          50% au 1er paiement + 10% récurrent à vie. Ton lien, tes stats, tes gains.
        </p>
      </div>

      {!profile ? (
        <div className="glass space-y-4 rounded-2xl p-6">
          <h2 className="text-lg font-semibold">Crée ton profil influenceur</h2>
