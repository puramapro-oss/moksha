/**
 * POST /api/legal/cookie-consent — garde une preuve DB du choix cookies d'un utilisateur
 * authentifié, indépendante du navigateur (le choix reste appliqué immédiatement côté client
 * via localStorage, cf CookieBanner.tsx — cet appel ne fait que synchroniser).
 */
