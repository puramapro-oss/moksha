 ...
 * confidentialité). Appelé à la création de compte (AuthForm.tsx) et par toute
 * ré-acceptation future si une version change.
 *
 * La version enregistrée est TOUJOURS CURRENT_LEGAL_VERSIONS[docType] calculée côté
 * serveur — jamais une valeur envoyée par le client (PIEGES.md §16).
 */
