 ...
 *
 * Pattern canonique arogya (packages/legal/src/api/account-delete.ts). checkRateLimit retiré :
 * src/lib/rate-limit.ts n'existe pas dans MOKSHA (ne bloque pas la conformité RGPD elle-même).
 */
