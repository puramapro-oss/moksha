...
export function useAuth() {
  ...
  return {
    ...
    isSuperAdmin: user?.email === SUPER_ADMIN_EMAIL || profile?.is_super_admin === true,
    isAdmin: profile?.is_admin === true || profile?.is_super_admin === true,
    plan: (profile?.plan ?? 'gratuit') as Profile['plan'],
  }
}
