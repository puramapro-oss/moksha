...
export default function SpiritualLayer() {
  ...
  return (
    ...
    >
      <div
        className={`relative mx-4 max-w-md rounded-3xl border border-white/10 bg-[var(--bg-nebula)]/95 p-8 text-center backdrop-blur-2xl shadow-[0_0_80px_rgba(255, 61, 0,0.15)] transition-all duration-500 ${
      ...
      >
        ...
        <div className="mb-6 flex justify-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#FF3D00]/20 to-[#FFB300]/20">
            <Sparkles className="h-8 w-8 text-[#FFB300]" />
          </div>
        </div>

        <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-[#FFB300]/60">
        ...
        <button
          ...
          className="magnetic-btn w-full rounded-xl bg-gradient-to-r from-[#FF3D00] to-[#FFB300] py-3.5 text-sm font-bold text-[#070B18] transition-all"
        >
          J&apos;int&egrave;gre ✨
        </button>
      </div>
