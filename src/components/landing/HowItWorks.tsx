          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="relative mb-5">
                <div className="flex h-[88px] w-[88px] items-center justify-center rounded-3xl border border-white/10 bg-[#0D1225] shadow-[0_8px_30px_-12px_rgba(255, 61, 0,0.35)] sm:h-[96px] sm:w-[96px]">
                  <s.icon className="h-8 w-8 text-[#FFB300]" />
                </div>
                <span className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br from-[#FF3D00] to-[#FFB300] text-[11px] font-bold text-[#070B18]">
                  {i + 1}
                </span>
              </div>
              ...
              <span className="mt-3 inline-block rounded-full border border-[#FF3D00]/30 bg-[#FF3D00]/10 px-3 py-1 text-[11px] font-semibold tracking-wide text-[#FF3D00]">
                {s.duration}
              </span>
            </motion.div>
          ))}
